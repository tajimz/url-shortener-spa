<template>
    ...
    >
        <div
            class="flex h-9 w-9 items-center justify-center rounded-xl bg-[#FF4433] text-white shadow-[0_4px_12px_rgba(255,68,51,0.25)] transition-transform duration-300 group-hover:scale-105"
        >
