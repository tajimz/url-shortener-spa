...
<template>
    ...
    <div class="min-h-screen bg-[#f9f9f8] p-6 text-[#18181b] dark:bg-[#0d0d0c] dark:text-[#EDEDEC] sm:p-12">
        ...
        <form
            ...
            class="mt-8 max-w-2xl rounded-3xl border border-black/[0.08] bg-white p-8 shadow-sm dark:border-[#3E3E3A]/40 dark:bg-[#161615]"
        >
            <div class="flex flex-col gap-6">
                ...
                <button
                    ...
                    class="mt-2 w-full rounded-xl bg-[#FF4433] py-3 font-semibold text-white shadow-[0_4px_12px_rgba(255,68,51,0.2)] transition-all hover:bg-[#e63222] active:scale-[0.98] disabled:opacity-50"
                >
